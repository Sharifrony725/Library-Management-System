...
$sql = "SELECT * FROM libarian WHERE email='$libarian_login' ";
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?php echo ucwords($libarian_info['first_name']) . ' ' . ucwords($libarian_info['last_name']) ?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="has-child-item open-item <?= $page == 'add_book.php' || 'manage_book.php' ? 'open-item' : '' ?> ">
                                ...
                                <li class="<?= $page == 'return_book.php' ? 'active-item' : '' ?>"><a href="return_book.php"><i class="fa fa-home" aria-hidden="true"></i><span>Return Book</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
